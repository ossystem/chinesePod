<template>
    ...
    <div class="answers">
        ...
        <div class="answers-inner">
            <SingleAnswerBlock class="anim" :class="{aa1: answerIndex !== 1, blink: answerIndex >= 1}" :start="answerIndex >= 1" variant="1" :answer="data[0]" :index="1"/>
            <SingleAnswerBlock class="anim" :class="{aa2: answerIndex !== 2, blink: answerIndex >= 2}" :start="answerIndex >= 2" variant="2" :answer="data[1]" :index="2"/>
            <SingleAnswerBlock class="anim" :class="{aa3: answerIndex !== 3, blink: answerIndex >= 3}" :start="answerIndex >= 3" variant="3" :answer="data[2]" :index="3"/>
            <SingleAnswerBlock class="anim" :class="{aa4: answerIndex !== 4, blink: answerIndex >= 4}" :start="answerIndex >= 4" variant="4" :answer="data[3]" :index="4"/>
        </div>
    </div>
    ...
    export default {
        ...
        mounted: function() {
           this.$store.subscribe((mutation,state) => {
               if (mutation.type === 'stopTimeoutTimer') {
        ...
        watch: {
          show: function() {
              if (this.show) {
                  setTimeout(()=>{this.playAllSounds(this.sounds);},1000);
